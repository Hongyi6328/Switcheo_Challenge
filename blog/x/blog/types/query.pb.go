...
func (m *QueryFilterPostRequest) Reset()         { *m = QueryFilterPostRequest{} }
func (m *QueryFilterPostRequest) String() string { return proto.CompactTextString(m) }
...
func (m *QueryFilterPostRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryFilterPostRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryFilterPostRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryFilterPostRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryFilterPostRequest.Merge(m, src)
}
func (m *QueryFilterPostRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryFilterPostRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryFilterPostRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryFilterPostRequest proto.InternalMessageInfo

func (m *QueryFilterPostRequest) GetKeyword() string {
	if m != nil {
		return m.Keyword
	}
	return ""
...
func (m *QueryFilterPostRequest) GetPagination() *query.PageRequest {
	if m != nil {
		return m.Pagination
	}
	return nil
...
func (m *QueryFilterPostResponse) Reset()         { *m = QueryFilterPostResponse{} }
func (m *QueryFilterPostResponse) String() string { return proto.CompactTextString(m) }
...
func (m *QueryFilterPostResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryFilterPostResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryFilterPostResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryFilterPostResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryFilterPostResponse.Merge(m, src)
}
func (m *QueryFilterPostResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryFilterPostResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryFilterPostResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryFilterPostResponse proto.InternalMessageInfo

func (m *QueryFilterPostResponse) GetPost() []Post {
	if m != nil {
		return m.Post
	}
	return nil
...
func (m *QueryFilterPostResponse) GetPagination() *query.PageResponse {
	if m != nil {
		return m.Pagination
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*QueryFilterPostRequest)(nil), "blog.blog.QueryFilterPostRequest")
	proto.RegisterType((*QueryFilterPostResponse)(nil), "blog.blog.QueryFilterPostResponse")
}
...
var fileDescriptor_a5bb36fa4271d1d5 = []byte{
	...
	,
}
...
type QueryClient interface {
	...
	// Queries a list of FilterPost items.
	FilterPost(ctx context.Context, in *QueryFilterPostRequest, opts ...grpc.CallOption) (*QueryFilterPostResponse, error)
}
...
func (c *queryClient) FilterPost(ctx context.Context, in *QueryFilterPostRequest, opts ...grpc.CallOption) (*QueryFilterPostResponse, error) {
	out := new(QueryFilterPostResponse)
	err := c.cc.Invoke(ctx, "/blog.blog.Query/FilterPost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QueryServer interface {
	...
	// Queries a list of FilterPost items.
	FilterPost(context.Context, *QueryFilterPostRequest) (*QueryFilterPostResponse, error)
}
...
func (*UnimplementedQueryServer) FilterPost(ctx context.Context, req *QueryFilterPostRequest) (*QueryFilterPostResponse, error) {
...
func _Query_FilterPost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryFilterPostRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).FilterPost(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blog.blog.Query/FilterPost",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).FilterPost(ctx, req.(*QueryFilterPostRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Query_FilterPost_Handler,
		},
	},
...
func (m *QueryFilterPostRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryFilterPostRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryFilterPostRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryFilterPostResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryFilterPostResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryFilterPostResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryFilterPostRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryFilterPostResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryFilterPostRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryFilterPostRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryFilterPostRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QueryFilterPostResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryFilterPostResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryFilterPostResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
